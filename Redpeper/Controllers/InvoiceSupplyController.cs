...
namespace Redpeper.Controllers
{
    ...
    public class InvoiceSupplyController : ControllerBase
    {
        ...
        public InvoiceSupplyController(ISupplyInvoiceRepository supplyInvoiceRepository, IUnitOfWork unitOfWork, ISupplyInvoiceDetailRepository supplyInvoiceDetailRepository)
        {
