    ...
    public class TransactionsInventoryByDateRangeExcelTemplate
    {
        public Byte[] GenerateExcelReport(List<InventoryTransactionDto> data, DateTime initDate, DateTime endDate)
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                worksheet.Cells[1, 1, 1, 11].Value = $"Detalle de transacciones {initDate.Date:dd/MM/yyyy} - {endDate.Date:dd/MM/yyyy}";
                ...
                worksheet.Cells[1, 13, 1, 14].Value = $"Consolidado de Insumos {initDate.Date:dd/MM/yyyy} - {endDate.Date:dd/MM/yyyy}";
