...
{
    public class SalesExcelByDateRangeTemplate
    {
        public Byte[] GenerateExcelReport(List<OrderReportDto> data, DateTime initDate, DateTime endDate)
        {
            byte[] fileContents;
            using (var package = new ExcelPackage())
            {
                ...
                for (int i = 0; i < data.Count; i++)
                {
                    ...
                    worksheet.Cells[i + 2, 1, i + 2, 5].Style.Border.Top.Style = ExcelBorderStyle.Thin;
                    worksheet.Cells[i + 2, 1, i + 2, 5].Style.Border.Bottom.Style = ExcelBorderStyle.Thin;
                    worksheet.Cells[i + 2, 1, i + 2, 5].Style.Border.Left.Style = ExcelBorderStyle.Thin;
                    worksheet.Cells[i + 2, 1, i + 2, 5].Style.Border.Right.Style = ExcelBorderStyle.Thin;
                    ...
                    worksheet.Cells[i + 2, 5].Value = data[i].Total;
                }

                worksheet.Cells[data.Count + 2, 1, data.Count + 2, 4].Merge = true;
                worksheet.Cells[data.Count + 2, 1, data.Count + 2, 4].Style.Border.Top.Style = ExcelBorderStyle.Double;
                worksheet.Cells[data.Count + 2, 1, data.Count + 2, 4].Style.Border.Bottom.Style = ExcelBorderStyle.Double;
                worksheet.Cells[data.Count + 2, 1, data.Count + 2, 4].Style.Border.Left.Style = ExcelBorderStyle.Double;
                worksheet.Cells[data.Count + 2, 1, data.Count + 2, 4].Style.Border.Right.Style = ExcelBorderStyle.Double;

                worksheet.Cells[data.Count + 2, 5].Style.Border.Top.Style = ExcelBorderStyle.Double;
                worksheet.Cells[data.Count + 2, 5].Style.Border.Bottom.Style = ExcelBorderStyle.Double;
                worksheet.Cells[data.Count + 2, 5].Style.Border.Left.Style = ExcelBorderStyle.Double;
                worksheet.Cells[data.Count + 2, 5].Style.Border.Right.Style = ExcelBorderStyle.Double;
                worksheet.Cells[data.Count + 2, 5].Style.Font.Bold = true;

                worksheet.Cells[data.Count + 2, 1, data.Count + 2, 4].Style.Font.Bold = true;
                worksheet.Cells[data.Count + 2, 1, data.Count + 2, 4].Style.Font.Size = 16;
                ...
                worksheet.Cells[data.Count + 2, 5].Style.Numberformat.Format = "$###,###,##0.00";
                worksheet.Cells[data.Count + 2, 5].Value = data.Sum(x => x.Total);
