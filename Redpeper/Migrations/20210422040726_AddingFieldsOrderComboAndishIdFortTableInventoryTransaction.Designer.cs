...
namespace Redpeper.Migrations
{
    ...
    [Migration("20210422040726_AddingFieldsOrderComboAndishIdFortTableInventoryTransaction")]
    partial class AddingFieldsOrderComboAndishIdFortTableInventoryTransaction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Redpeper.Model.OrderType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Redpeper.Model.ComboImage", b =>
                {
                    b.HasOne("Redpeper.Model.Combo")
                        .WithOne("ComboImage")
                        .HasForeignKey("Redpeper.Model.ComboImage", "ComboId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Redpeper.Model.DishImage", b =>
                {
                    b.HasOne("Redpeper.Model.Dish")
                        .WithOne("DishImage")
                        .HasForeignKey("Redpeper.Model.DishImage", "DishId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Redpeper.Model.Order", b =>
                {
                    ...
                    b.HasOne("Redpeper.Model.OrderType", "OrderType")
                        .WithMany()
